...
void AmbiEncoderAudioProcessorEditor::resized()
{
    ...
    sliderPanPosition->setBounds (64, 64, 240, 32);
...
<JUCER_COMPONENT documentType="Component" className="AmbiEncoderAudioProcessorEditor"
  ...
  <SLIDER name="new slider" id="62fc45f6b7b51c4" memberName="sliderPanPosition"
          virtualName="" explicitFocusOrder="0" pos="64 64 240 32" min="0"
